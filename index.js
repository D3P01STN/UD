...
const asw1 = 'https://l.top4top.io/p_2128088x97.jpeg'
...
autoketik = false;
prefixStatus = true;
targetpc = "6282233486524"; 
owner = "6282233486524"; 
fakeyoi = "𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉 BOT︎"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6282233486524@s.whatsapp.net`]
...
/*const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6282233486524?text=Assalamualaikum`}}})
		}*/
      ...
      message: {
        productMessage: {
          product: {
            ...
            description: "𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉 BOT",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉",
            productImageCount: 1,
          },
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/HAYnmNmnjr4KIjKxe6GRtY', "groupName": `Argio Dev`, "footerText": "*_© Dcode Denpa_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
// Katalog
const reply = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             itsmevall.relayWAMessage(res)
        }
const fakewa = (teks) => {        
itsmevall.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6282233486524?text=Assalamualaikum`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://l.top4top.io/p_2128088x97.jpeg",
                "thumbnail": fake,
                "sourceUrl": ``
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6282233486524`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6282233486524`,
                "thumbnailUrl": "https://l.top4top.io/p_2128088x97.jpeg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6282233486524`,
...
"mediaType": "2",
"thumbnailUrl": "https://l.top4top.io/p_2128088x97.jpeg",
"mediaUrl": "https://youtu.be/yJdYWnqH6m8",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6282233486524@s.whatsapp.net";
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉︎', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Terimakasih Telah Terdaftar 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hai ${pushname}\n ${ucapanWaktu} Kak 👋`
               ...
               {buttonId:`${prefix}command`,buttonText:{displayText:'MENUシ︎'},type:1}]
...
groups = itsmevall.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6282233486524@s.whatsapp.net"
        dtod = '6282233486524'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              itsmevall.sendMessage('6282233486524@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://instagram.com/uwu_depoistn')
break
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/YTzj33B/tsukasa.png",
                "thumbnail": fs.readFileSync(`./itsmevall.jpg`),
                "sourceUrl": "https://youtube.com/c/𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        itsmevall.toggleDisappearingMessages(from, 0)
...
㋛${prefix}tiktokmusic
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉 シ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}kickarea
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉"
    }
  }, {quoted: freply})
...
case 'script':
		case 'sc':
		case 'sourcecode':
		itsmevall.sendMessage(from, { text: "https://github.com/D3P015TN", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
case 'hacked':
  if (!mek.key.fromMe) return;
              ...
              if (args.length < 1) return reply('Teksnya?')
              reply('Otw Hack')
                tessgc = await getBuffer(`https://i.ibb.co/YTzj33B/20210319-204838.jpg`)
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @uwu_depoistn ☹︎`,buttons,headerType:4}
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉︎`, [
            {              
...
itsmevall.sendMessage(_.jid, 
			...
			"footerText": '𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉︎',
			"buttons": [
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @uwu_depoistn`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
case 'lesbian':
...
case 'listnulis':
  ...
  🌹 ${prefix}nulis 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉
  🌹 ${prefix}foliokanan 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉
  🌹 ${prefix}foliokiri 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉
  🌹 ${prefix}nuliskanan 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉
  🌹 ${prefix}nuliskiri 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉`)
  break
case 'foliokiri':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
...
itsmevall.sendMessage(from, stdout, text, term)
    ...
    if (isGroup && budy != undefined) {
      ...
      console.log(
        color("[𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉]", "red"),
        "𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉︎",
        color(sender.split("@")[0])
      );
    }
   } catch (e) {
